        ...
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a
              ...
              className="flex items-center space-x-2 bg-blue-600 text-white px-6 py-2.5 rounded-full font-medium hover:bg-blue-700 transition-all duration-200 shadow-md hover:shadow-lg"
            >
              <Phone size={18} />
